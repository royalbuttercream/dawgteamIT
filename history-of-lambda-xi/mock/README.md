...
- The newspaper article transcript is pending the chapter and marked "transcript pending" under the photograph.
...
| Read the newspaper article | 1 then scroll; the text exists only as a photograph, illegible at 375 px | not present | 1 (jump link) to the photo with a real description; transcript pending the chapter |
...
| Newspaper photograph, alt equivalent to "Section image" | Same photo, a real description, a caption, transcript pending |
...
| Newspaper article transcript not delivered | Open. Needs the chapter. |
